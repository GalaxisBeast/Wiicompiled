...
if (AURORA_ENABLE_OPENXR)
    if (NOT WIN32 OR NOT AURORA_ENABLE_GX OR NOT DAWN_ENABLE_D3D12)
        message(FATAL_ERROR "The current OpenXR implementation requires Windows and Dawn D3D12")
    endif ()
    target_compile_definitions(aurora_core PUBLIC AURORA_ENABLE_OPENXR XR_USE_GRAPHICS_API_D3D12 XR_USE_PLATFORM_WIN32)
    target_sources(aurora_core PRIVATE lib/openxr.cpp)
    target_link_libraries(aurora_core PRIVATE OpenXR::openxr_loader d3d12 dxgi)
endif ()
